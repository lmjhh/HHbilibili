...
- (void)launchAnimation{
    ...
    self.bgImageView = [[UIImageView alloc] initWithFrame:BScreen_Bounds];
    self.bgImageView.image = [UIImage imageNamed:@"bilibili_splash_iphone_bg"];
    
    
    self.iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(BScreen_Width/2 - 7.5, BScreen_Height/2 - 100, 30, 40)];
