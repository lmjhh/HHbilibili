...
- (void)refreshDataCompleteHandle:(void(^)(NSError *error))complete{
    ...
    [[BiLi_NetAPIManager sharedManager] GetVideoWithParameter:self.aid completionHandler:^(VideoModel *responseObj, NSError *error) {
      
        self.list = responseObj.durl;
        
        [[BiLi_NetAPIManager sharedManager] DownDanMuWithParameter:[self videoCid]  completionHandler:^(NSDictionary *responseObj, NSError *error) {
