...
@interface Live_MostNewViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation Live_MostNewViewController
...
- (void)loadDataFormNet{
    ...
    [[BiLi_NetAPIManager sharedManager] request_MostNewDataWithBlock:_Index dataBlock:^(id data, NSError *error) {
